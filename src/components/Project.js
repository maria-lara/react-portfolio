...
function Project(props) {
    ...
    <div className="container">
        <div className="row border">
            ...
            <a target="_blank" className="btn btn-primary m-1" href={props.deployedAppURL} >View Deployed Application</a>
            <a target="_blank" class="btn btn-secondary text-center m-1" href={props.githubURL}>View Github Repository</a>
        </div>
    </div>
    )
