...
function AboutMe() {
    ...
    <div className="container">
        ...
        <div class="row m-3">
            <a class="col mx-auto" href="https://www.linkedin.com/in/maria-lara-sf/"><img alt="" class="icon" src="./assets/LI-In-Bug.png" /></a>
            <a class="col mx-auto" href="https://github.com/maria-lara"><img class="icon" src="./assets/Octocat.png" /></a>
            <a class="col mx-auto" href="mailto:mariaerlara@gmail.com"><img class="icon" src="./assets/gmail.png" /></a>
            <a class="col" target="_blank" href="https://drive.google.com/file/d/1nJCFbYevE7jfEVj9vZs6Cp7yp1dNB3eh/view?usp=sharing"><img class="icon" src="./assets/resume.png" /></a>
        </div>
    </div>
    )
}
